...
# Define the local file path and the name it will have in the Azure container
...
# Create a client that connects to Azure Storage account
...
# Create a client for the file (blob) to upload
...
# Open the local file and upload it to Azure Blob Storage
